...
function updateImageTitle(){
    var name = document.getElementById("imageTitle").value;
    console.log("hi i found the image title: "+name);

    var img = allImages[currMenuIndex];

    console.log("received the image: "+allImages[currMenuIndex]._id);

    $.get("/updateImageTitle", {id: img._id, name: name}, function(data){
        console.log(data);
